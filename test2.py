...
MODEL_PATH = 'sign_language_model_2.h5'
...
# Class names (modify as per your model's training data)
class_names = ['Down', 'Drink', 'Eat', 'Love', 'Sorry', 
               'Up', 'Wait', 'Washroom', 'Wow']
...
if option == "Upload Image":
    ...
    if uploaded_image is not None:
        ...
        if processed_image_path:
            ...
            st.image(bbox_image_path, caption="Detected Hand with Bounding Box", use_container_width=True)
